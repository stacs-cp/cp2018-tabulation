...
public class TransformConstMatrixClass extends TreeTransformerBottomUpNoWrapper
{
    ...
    protected NodeReplacement processNode(ASTNode curnode)
	{
	        ...
	        !(curnode.getParent() instanceof CompoundMatrix) && isConstantMatrix(curnode) )
        {
            ...
            // Should use newAuxId
            m.cmstore.newConstantMatrix("_MATRIX_ujbstj_"+matcounter, (CompoundMatrix) curnode.copy());
            return new NodeReplacement(new Identifier(m, "_MATRIX_ujbstj_"+matcounter));
        }
        return null;
    }
