...
variableloop:
            while(itr!=null)
            {
                if(itr.cat==ASTNode.Decision || itr.cat==ASTNode.Auxiliary) {
                    ...
                    ASTNode id=new Identifier(m, name);
                    ...
                    if(ls==null || ls.size()==0) {
                        ...
                        CmdFlags.warning("Variable "+name+" is not in the scope of any constraint.");
                        ...
                        if(id.isRelation()) {
                            ...
                            m.global_symbols.assignVariable(id, NumberConstant.make(p.lower));
                        }
                        ...
                        for(int i=0; i<domvals.size(); i++) {
                            ...
                            ReplaceASTNode r=new ReplaceASTNode(id, NumberConstant.make(domvals.get(i)));
