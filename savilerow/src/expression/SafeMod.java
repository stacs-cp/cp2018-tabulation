...
public class SafeMod extends BinOp
{
	...
	public PairASTNode getBoundsAST() {
	    ...
	    a.e1=BinOp.makeBinOp("+", a.e1, NumberConstant.make(1));
	    a.e2=BinOp.makeBinOp("-", a.e2, NumberConstant.make(1));
	    
	    // Extend the interval to include 0. 
	    a.e1=new Min(NumberConstant.make(0), a.e1);
	    a.e2=new Max(NumberConstant.make(0), a.e2);
	    return a;
	}
