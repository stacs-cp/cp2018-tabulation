...
public class SafePower extends BinOp
{
	...
	public PairASTNode getBoundsAST() {
	    ...
	    ASTNode exp1=b.e2;
	    ASTNode exp2=BinOp.makeBinOp("-", b.e2, NumberConstant.make(1));
	    ASTNode explow=b.e1;
	    // put the new bounds into b.
	    ...
	    // Add zero for undef
	    b.e2=new Max( b.e2, NumberConstant.make(0));
	    b.e1=new Min( b.e1, NumberConstant.make(0));
	    
	    // Add one for undef for Minion
	    b.e2=new Max( b.e2, NumberConstant.make(1));
	    b.e1=new Min( b.e1, NumberConstant.make(1));
